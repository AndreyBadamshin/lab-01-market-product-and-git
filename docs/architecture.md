...
I assume that message sending process is divide into several steps to ensure the fast message delivery. 

I assume that security measures are applyied on each step.
